...
public class ExportOrderControllerTest {

    @Autowired
    ExportOrderController exportOrderController;
    ...
    void confirmOrderWithOrderIdIsString() throws Exception {
        ...
        String uri = "/api/export/confirm?orderId=Minh&confirmBy=1";
    ...
    void confirmOrderWithNoOrderId() throws Exception {
        ...
        String uri = "/api/export/confirm?orderId=&confirmBy=1";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void confirmOrderWithConfirmByIsString() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);
        String uri = "/api/export/confirm?orderId=1&confirmBy=Minh";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void confirmOrderWithNoConfirmBy() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);
        String uri = "/api/export/confirm?orderId=1&confirmBy=";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void cancelOrderWithOrderIdIsString() throws Exception {
        ...
        String uri = "/api/export/cancel?orderId=Minh&confirmBy=1";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void cancelOrderWithNoOrderId() throws Exception {
        ...
        String uri = "/api/export/cancel?orderId=&confirmBy=1";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void cancelOrderWithConfirmByIsString() throws Exception {
        ...
        String uri = "/api/export/cancel?orderId=1&confirmBy=Minh";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void cancelOrderWithNoConfirmBy() throws Exception {
        ...
        String uri = "/api/export/cancel?orderId=1&confirmBy=";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void editOrderWithOrderIdIsString() throws Exception {
        ...
        String uri = "/api/export/editOrder?orderId=Minh";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void editOrderWithNoOrderId() throws Exception {
        ...
        String uri = "/api/export/editOrder?orderId=";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put(uri)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(consignmentProductDTOList)))
                .andReturn();
    ...
    @Test
    void getListExportOrderWithStatusIsString() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);

        String uri = "/api/export/list?status=aaa";
    ...
    @Test
    void getListExportOrderWithDateFromIsString() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);

        String uri = "/api/export/list?dateFrom=aaa";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    @Test
    void getListExportOrderWithDateToIsString() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);

        String uri = "/api/export/list?dateTo=aaa";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    @Test
    void getListExportOrderWithPageIndexIsString() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);

        String uri = "/api/export/list?pageIndex=aaa";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    @Test
    void getListExportOrderWithPageSizeIsString() throws Exception {
        ResponseEntity response = new ResponseEntity("", HttpStatus.BAD_REQUEST);

        String uri = "/api/export/list?pageSize=aaa";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
    ...
    void getOrderDetailWithOrderIdIsString() throws Exception {
        ...
        String uri = "/api/export/getOrderDetail?orderId=aaa";
        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get(uri)
                        .contentType(MediaType.APPLICATION_JSON))
                .andReturn();
        int status = mvcResult.getResponse().getStatus();
